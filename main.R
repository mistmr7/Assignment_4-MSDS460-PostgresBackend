...
tic <- Sys.time()
full_query_create_times <- create_full_query(10, 50, 1000)
full_query_read_times <- read_full_query(10, 50, 1000)
full_query_update_times <- update_full_query(10, 50, 1000)
full_query_delete_times <- delete_full_query(10, 50, 1000)
text_query_create_times <- create_text_query(10, 50, 1000)
text_query_read_times <- read_text_query(10, 50, 1000)
text_query_update_times <- update_text_query(10, 50, 1000)
text_query_delete_times <- delete_text_query(10, 50, 1000)
integer_query_create_times <- create_int_query(10, 50, 1000)
integer_query_read_times <- read_integer_query(10, 50, 1000)
integer_query_update_times <- update_integer_query(10, 50, 1000)
integer_query_delete_times <- delete_integer_query(10, 50, 1000)
float_query_create_times <- create_float_query(10, 50, 1000)
float_query_read_times <- read_float_query(10, 50, 1000)
float_query_update_times <- update_float_query(10, 50, 1000)
float_query_delete_times <- delete_float_query(10, 50, 1000)
json_query_create_times <- create_json_query(10, 50, 1000)
json_query_read_times <- read_json_query(10, 50, 1000)
json_query_update_times <- update_json_query(10, 50, 1000)
json_query_delete_times <- delete_json_query(10, 50, 1000)
bjson_query_create_times <- create_bjson_query(10, 50, 1000)
bjson_query_read_times <- read_bjson_query(10, 50, 1000)
bjson_query_update_times <- update_bjson_query(10, 50, 1000)
bjson_query_delete_times <- delete_bjson_query(10, 50, 1000)
geometry_query_create_times <- create_geometry_query(10, 50, 1000)
geometry_query_read_times <- read_geometry_query(10, 50, 1000)
geometry_query_update_times <- update_geometry_query(10, 50, 1000)
geometry_query_delete_times <- delete_geometry_query(10, 50, 1000)
toc <- Sys.time()
